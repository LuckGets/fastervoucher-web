...
const LoginAdminWrapper = () => {
  return (
    <div className="m-auto mt-10 flex flex-col items-center gap-6 bg-[#F7F3ED] md:ml-[15%]">
      <h1 className="text-center text-2xl">Login</h1>
      <div className="mx-auto w-[20rem] rounded-3xl border bg-[#D9DFD7] p-4 shadow-xl md:mx-44 md:w-[35rem]">
        <LoginForm />
