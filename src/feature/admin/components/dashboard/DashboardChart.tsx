  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6 grid grid-cols-4 gap-4">
        ...
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">1,500</h3>
          <p>Sellable voucher</p>
        </div>
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">435</h3>
          <p>Order</p>
        </div>
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">6</h3>
          <p>All voucher</p>
        </div>
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">1,200</h3>
          <p>Redeemed</p>
        </div>
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">300</h3>
          <p>Expired</p>
        </div>
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">6</h3>
        ...
        <div className="rounded-xl bg-[#E1E1E1] p-4 text-center">
          <h3 className="text-2xl font-medium text-[#2BB673]">104</h3>
          <p>Account user</p>
        </div>
      </div>
